...
(function( jQuery ) {
	...
	jQuery.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Total-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalCurrency = "BDT"; // PayPal's currency code
			this.paypalBusinessEmail = ""; // Your Business PayPal's account email address
			this.paypalURL = "https://www.bkash.com/en/products-services/payment"; // The URL of the PayPal's form
